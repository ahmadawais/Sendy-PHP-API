...
// 2. Configuration.
$config = [
	'sendyUrl' => 'https://mails.ahmadawais.com',  // Your Sendy installation URL (without trailing slash).
	'apiKey'   => 'oGe89pHAxdLWJXxtfwdR', // Your API key. Available in Sendy Settings.
	'listId'   => 'plQ8x763WuAqPm5ZbyEZCYDA',
];
...
$responseArray = $sendy->subscribe(
	[
		...
		'ipaddress' => '39.45.198.204', // User IP address (optional).
